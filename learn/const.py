...
URL={
	...
	'file' : 'http://learn.tsinghua.edu.cn/MultiLanguage/lesson/student/download.jsp',		#课程文件
	'homework' : 'http://learn.tsinghua.edu.cn/MultiLanguage/lesson/student/hom_wk_brw.jsp',		#课程作业
	'homework_detail' : 'http://learn.tsinghua.edu.cn/MultiLanguage/lesson/student/hom_wk_detail.jsp', #作业详细
	'discuss' : 'http://learn.tsinghua.edu.cn/MultiLanguage/public/bbs/gettalkid_student.jsp',		#课程讨论
